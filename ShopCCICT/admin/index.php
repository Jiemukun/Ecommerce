                ...
                <table class="table table-striped table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Gcash Reference</th>
                    ...
                    <tbody>
                        <?php foreach($orders as $order) {?>
                            <tr>
                                ...
                                <td style="color: <?php echo ($order['order_status'] === 'paid') ? 'green' : (($order['order_status'] === 'unpaid') ? 'red' : 'black'); ?>; font-weight: bold;">
                                ...
                                <!-- Display Gcash Reference and Payment Proof -->
                                <td><?php echo $order['gcash_reference_number'] ? $order['gcash_reference_number'] : 'Not Provided'; ?></td>
                                <td>
                                    <?php if ($order['payment_image']) { ?>
                                        <a href="/ShopCCICT/<?php echo $order['payment_image']; ?>" target="_blank">
                                            <img src="/ShopCCICT/<?php echo $order['payment_image']; ?>" style="width: 50px; height: 50px;" alt="Payment Proof">
                                        </a>
